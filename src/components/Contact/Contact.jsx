...
function Contact() {
  ...
  return (
      ...
      <div className="contact__left">
        ...
        <div className="contact__left--content">
          <div className="contact__left--content_item">
            ...
            <article>
              <p>lenambaohuy107@gmail.com</p>
              <a
                href="mailto:lenambaohuy107@gmail.com"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="contact__left--content_item">
            ...
            <article>
              <p>Bảo Huy</p>
              <a
                href="https://www.facebook.com/messages/t/100004306622067"
                className="cursor_small"
                target="_blank"
                rel="noreferrer"
              >
	...
	c-2.209,0-4-1.791-4-4s1.791-4,4-4c31.984,0,58.006,26.021,58.006,58.006C151.866,109.153,150.075,110.944,147.866,110.944z"
            ...
            <article>
              <p>+ 84932 049 409</p>
              <a href="tel:0932049409" className="cursor_small">
                Make a phone call
              </a>
            </article>
          </div>
